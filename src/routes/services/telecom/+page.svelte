...
<section
  class=" light relative py-[60px] md:pt-0 md:pb-[100px] z-[1] mx-auto my-10 md:my-24"
>
...
L’installation, l’upgrade, le swap et la mise en service d’équipements actifs.<br>
Le raccordement des abonnés et les interventions SAV.<br>
La maintenance préventive et curative des réseaux.
        </p>
      </div>
      <div class="col-span-12 lg:col-span-5 lg:col-start-8 text-center justify-center items-center">
        <img
          src={fibreOptiqueLogo}
          alt=""
          class=" mx-auto md:py-20 rounded-md max-h-[700px]"
        />
      </div>
    </div>
  </div>
